let weatherData = {
  ...
  "properties": {
    "meta": {
      "updated_at": "2021-10-12T08:51:03Z",
      "units": {
...
let geometry = weatherData2.geometry;
let meta = weatherData2.properties.meta;
let data = weatherData2.properties.timeseries;
...
let thisTime = prognosTime.slice(11, 16);
...
document.getElementById("compassRose").innerHTML = compassRose(direction);
