...
//   const weatherNow = data[selectedHour].data.instant.details;
  ...
  const nextHour = data[selectedHour].data.next_1_hours.details.precipitation_amount;
  const nextHourSum = data[selectedHour].data.next_1_hours.summary;
  ...
  const sixHour = data[selectedHour].data.next_6_hours.details.precipitation_amount;
  const sixHourImg = data[selectedHour].data.next_6_hours.summary.symbol_code + ".png";
  const imgSource6 = "img/png/" + sixHourImg;
  
  const twelveHourImg = data[selectedHour].data.next_12_hours.summary.symbol_code + ".png";
